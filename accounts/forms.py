...
class WorkplaceForm(forms.ModelForm):
	...
	class Meta:
		model=Workplace
		fields=['first_name','website','description','username','email','password','address','logo','wcategory']
		exclude=['last_name']
...
class EmployeeForm(forms.ModelForm):
	...
	class Meta:
		model=Employee
		fields=['username','first_name','last_name','gender','profile_picture','email','password','employee_id','designation','eworkplace']		
